...
import com.ody.auth.domain.logincontext.ExistingUserForExistingDevice;
...
class ExistingUserForExistingDeviceTest {
    ...
    void syncDevice() {
        ...
        Member authorizedMember = authorizationType.syncDevice(Optional.of(member), Optional.of(member), member);
